...
# Drop non-numeric columns (user, is_red_team, and any categorical columns like risk_profile, department, role)
numeric_cols = df.select_dtypes(include=[np.number]).columns.tolist()
feature_cols = [c for c in numeric_cols if c not in ['is_red_team']]
X = df[feature_cols]
